    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(to='prozdo_main.Comment', null=True, related_name='children', blank=True)),
            ],
            options={
                'ordering': ['-created'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ForeignKey(to='prozdo_main.Comment', null=True, related_name='history_comment', blank=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='Blog',
            fields=[
                ('post_ptr', models.OneToOneField(auto_created=True, serialize=False, primary_key=True, to='prozdo_main.Post', parent_link=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(editable=False, db_index=True)),
                ('level', models.PositiveIntegerField(editable=False, db_index=True)),
                ('parent', mptt.fields.TreeForeignKey(to='prozdo_main.Category', null=True, related_name='children', blank=True)),
            ],
            options={
                'ordering': ('title',),
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('components', models.ManyToManyField(verbose_name='Состав', related_name='drugs', blank=True, to='prozdo_main.Component')),
            ],
            options={
                'ordering': ('title',),
                'abstract': False,
        ...
        migrations.AddField(
            model_name='cosmetics',
            name='line',
            field=models.ForeignKey(to='prozdo_main.CosmeticsLine', null=True, verbose_name='Линейка', blank=True),
        ),
        migrations.AddField(
            model_name='cosmetics',
            name='usage_areas',
