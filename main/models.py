...
class Comment(super_models.SuperComment):
    ...
    confirm_comment_text_template_name = 'main/comment/email/confirm_comment_html_template.txt'
    confirm_comment_html_template_name = 'main/comment/email/confirm_comment_text_template.html'
