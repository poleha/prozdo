...
class PostTests(BaseTest):
    def test_marks_count_and_average_mark_works_as_expected_for_drug_detail(self):
        ...
        self.assertIn('<span itemprop="ratingCount" id="post-marks-count">1</span>', page)
        ...
        page = self.app.get(reverse('post-detail-pk', kwargs={'pk': drug.pk}))
        self.assertIn('<span itemprop="ratingValue" id="post-average-mark">4,5</span>', page)
        self.assertIn('<span itemprop="ratingCount" id="post-marks-count">2</span>', page)
        ...
        page = self.app.get(reverse('post-detail-pk', kwargs={'pk': drug.pk}))
        self.assertIn('<span itemprop="ratingValue" id="post-average-mark">5,0</span>', page)
        self.assertIn('<span itemprop="ratingCount" id="post-marks-count">1</span>', page)
        self.assertEqual(drug.marks_count, 1)
        self.assertEqual(drug.average_mark, 5)
        self.assertEqual(drug.post_ptr.marks_count, 1)
